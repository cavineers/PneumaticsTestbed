...
public class SetSafety extends CommandBase {
  ...
  public SetSafety(RobotContainer container, RobotContainer.SafetyMode desiredMode) {
    ...
    container.m_joy.setRumble(RumbleType.kLeftRumble, 1.0);
    container.m_joy.setRumble(RumbleType.kRightRumble, 1.0);
  }
  ...
  public void end(boolean interrupted) {
    this.rc.m_joy.setRumble(RumbleType.kLeftRumble, 0.0);
    this.rc.m_joy.setRumble(RumbleType.kRightRumble, 0.0);
  }
